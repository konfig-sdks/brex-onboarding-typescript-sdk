...
/**
 * This class provides a wrapper for network errors when making requests to Onboarding API
 */
export class BrexOnboardingError extends Error {
  /**
   * The response body
   */
